...
class Donor extends Component {
    ...
    componentDidMount() {
        callApi("GET", "https://bbackend-production-da9c.up.railway.app/donors/readdonor", "", this.readDonorResponse);
    }
    ...
    saveDonorDetails = () => {
        ...
        if (this.state.id === "") {
            callApi("POST", "https://bbackend-production-da9c.up.railway.app/donors/insert", data, this.saveDonorResponse);
        } else {
            callApi("PUT", "https://bbackend-production-da9c.up.railway.app/donors/update", data, this.saveDonorResponse);
        }
    }
    ...
    updateDonor(id) {
        callApi("GET", "https://bbackend-production-da9c.up.railway.app/donors/getdonor/" + id, "", this.updateDonorresponse);
    }
    ...
    deleteDonor(id) {
        ...
        if (!resp) return;
        callApi("DELETE", "https://bbackend-production-da9c.up.railway.app/donors/delete/" + id, "", this.saveDonorResponse);
    }
